...
#include "SlidingHints3.generated.h"

UCLASS()
class HINTSYSTEM_API ASlidingHints3 : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Scores)
		int32 puzzle3LocalTimerScore;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Scores)
		int32 puzzle3LocalActiveTimerScore;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Scores)
		int32 puzzle3LocalMovesScore;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Scores)
		int32 puzzle3LocalHintsScore;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Scores)
		int32 puzzle1LocalFinalScore;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Scores)
		int32 puzzle2LocalFinalScore;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Hints)
		bool puzzle3LocalEnter;
